...
<div id="content">
    ...
    <a target="blank" href="pages/cetak.php"><img src="print.png" height="50px" height="50px" alt=""></a>
    <FORM CLASS="form-inline" METHOD="POST">
    <div align="right"><form method="post"><input type="text" name="pencarian">
    <input type="submit" name="search" value="search" class="tombol"></form></div>
    </FORM>
    </p>
    <table id="table-tampil">
        <tr>
            <th id="label-tampil"> No</th>
            <th>ID Anggota</th>
            <th>Nama</th>
            <th>Foto</th>
            <th>Jenis Kelamin</th>
        ...
        <tr>
            ...
            <td><?php echo $r_tampil_anggota['jeniskelamin']; ?></td>            <td><?php echo $r_tampil_anggota['idanggota']; ?></td>
            ...
            <td>
                ...
                <div class="tombol-opsi-container">
                    ...
                    onclick = "return_confirmation('Apakah Anda Yakin Akan Menghapus Data Ini?')"class="tombol">Cetak Kartu</a>
                </div>   
            </td>
        </tr>
        <?php $nomor++; }
